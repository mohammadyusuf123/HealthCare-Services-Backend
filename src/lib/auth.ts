...
export const auth = betterAuth({
  ...
  user:{
         additionalFields: {
          role: { type: "string", defaultValue: Role.PATIENT,required: true },
          phone: { type: "string", required: false },
          status: { type: "string", defaultValue: UserStatus.ACTIVE, required: true },
          needPasswordChnage: { type: "boolean", defaultValue: false, required: true },
          isDeleted: { type: "boolean", defaultValue: false, required: true },
          deleteAt: { type: "date",defaultValue: null, required: false },
         }
    },
      emailAndPassword: { 
    enabled: true, 
